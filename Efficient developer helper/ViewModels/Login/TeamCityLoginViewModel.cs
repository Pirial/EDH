...
{
    public class TeamCityLoginViewModel : NotifyPropertyChangedViewModel, ILoginViewModel
    {
        ...
        private Action<TeamCityClient> _loginCallback;

        public event EventHandler<AutentificatedEventArgs> AutentificatedEvent;
        public TeamCityLoginViewModel(Action<TeamCityClient> callback )
        {
        ...
        {
            get { return ResourceStrings.TeamCity; }
        }
